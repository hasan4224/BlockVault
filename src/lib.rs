...
#[derive(Debug)]
pub struct BlockVaultProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BlockVaultProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BlockVault processing");
    
    let mut processor = BlockVaultProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BlockVaultProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BlockVaultProcessor::new(false);
